...
import Profile from "@/assets/images/Baramee.png";
  ...
  return (
    <div className="w-[320px] bg-black border border-[#2a2a2e] rounded-[20px] p-6 shadow-xl">
      ...
      <h2 className="text-[25px] tracking-wide text-white mb-1">
        <span className="text-[#ff6a00]">B</span>aramee
      </h2>
      ...
      <div className="flex justify-center gap-6 mt-6 text-[26px] text-[#d4d4d8]">
        ...
        <a
          href="https://www.facebook.com/baramee.sutthichuai"
          target="_blank"
        ...
        <a
          href="https://github.com/BarameeEiEi"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:text-[#ff6a00] transition"
        >
        ...
        <a
          href="https://www.instagram.com/brameeg/"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:text-[#ff6a00] transition"
        >
        ...
        <a
          href="mailto:Baramee.Sutthichuai@email.com"
          className="hover:text-[#ff6a00] transition"
        >
          <FaGoogle />
        </a>
